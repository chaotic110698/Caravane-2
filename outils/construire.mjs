...
trace('## Rien n\'est à prendre ou à laisser', '',
  'Toute icône se retouche, d\'où qu\'elle vienne.', '',
  `Le bouton **Partir d'une icône du jeu** reprend l'un des ${Object.keys(ICO.glyphesEvenement).length} dessins livrés`,
...
trace('### Les grades, ou à quoi sert vraiment la composition', '',
  `La famille **${((pieces.familles || {}).grades || {}).nom || 'Grades et emblèmes'}** en `+
  `contient ${pieces.pieces.filter(p => p.famille === 'grades').length}, et elle est bâtie sur`,
